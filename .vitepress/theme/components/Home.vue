...
<template>
  <section id="hero">
    ...
    <p class="actions">
      ...
      <a class="security" href="https://v2.vuejs.org/eol/" target="_blank">
        Получите обновления безопасности для Vue 2
        <svg
          class="icon"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
  ...
  <section v-else id="special-spsr">
    <span>
      <a href="/sponsor/#tier-benefits">
        Слот особого спонсора свободен — узнайте подробности
      </a>
    </span>
  </section>
  ...
  <section id="highlights" class="vt-box-container">
    <div class="vt-box">
      <h2>Универсальный</h2>
      <p>
        Экосистема, которую можно подключать постепенно: от библиотеки до
    ...
    <div class="vt-box">
      <h2>Доступный</h2>
      <p>
        Опирается на HTML, CSS и JavaScript. Понятное API и сильная
        документация.
      </p>
    </div>
    <div class="vt-box">
      ...
      <p>
        Реактивная отрисовка с оптимизацией на этапе компиляции — редко
        приходится доводить производительность вручную.
      </p>
    </div>
  </section>
