...
Для проекта требуется Node.js версии `v20` или выше. Рекомендуется включить corepack:
...
- До переезда на VitePress уже была [документация для Vue 3 переведенная на русский язык](https://v3.ru.vuejs.org/)
