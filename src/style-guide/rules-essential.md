...
Это релевантно только для [однофайловых компонентов](/guide/scaling-up/sfc). Это _не_ требует использования [`scoped` атрибута](/api/sfc-css-features#scoped-css). Скрытие стилей может быть достигнуто также при помощи [CSS-модулей](/api/sfc-css-features#css-modules), методологии [BEM](https://getbem.com/) или других библиотек/соглашений.
