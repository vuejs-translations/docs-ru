...
Объект, возвращенный из параметра [`data`](./options-state#data), который компонент сделал реактивным. Экземпляр компонента проксирует доступ к свойствам объекта данных.
...
- **Подробности**
  ...
  Если слот является [слотом с ограниченной областью действия](/guide/components/slots#scoped-slots), аргументы, переданные функциям слота, доступны слоту в качестве реквизита слота.
...
- **Подробности**
  ...
  Второй аргумент - это коллбэк вызова. Обратный вызов получает новое значение и старое значение наблюдаемого источника.
