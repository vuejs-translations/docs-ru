...
- **Подробности**
  ...
  Этот хук обычно используется для выполнения сайд эффектов, требующих доступа к отрисованному DOM дереву компонента, или для ограничения кода, связанного с DOM, на клиенте в [приложении с серверным рендерингом](/guide/scaling-up/ssr).
