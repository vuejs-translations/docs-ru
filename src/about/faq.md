...
Vue — это независимый, управляемый сообществом проект. Он был создан [Эваном Ю](https://x.com/youyuxi) в 2014 году как личный сайд-проект. Сегодня Vue активно поддерживается [командой, состоящей из штатных сотрудников и волонтеров со всего мира](/about/team), где Эван выступает в качестве руководителя проекта. Вы можете узнать больше об истории Vue в этом [документальном фильме](https://www.youtube.com/watch?v=OrxmtDw4pVI).
